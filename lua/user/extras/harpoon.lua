...
function M.config()
  ...
  keymap("n", "<c-n>", "<cmd>lua require('harpoon'):list():select(1)<cr>", opts)
  keymap("n", "<c-m>", "<cmd>lua require('harpoon'):list():select(2)<cr>", opts)
  keymap("n", "<c-,>", "<cmd>lua require('harpoon'):list():select(3)<cr>", opts)
  keymap("n", "<c-.>", "<cmd>lua require('harpoon'):list():select(4)<cr>", opts)
