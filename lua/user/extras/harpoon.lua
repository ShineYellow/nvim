...
function M.config()
  ...
  keymap("n", "n", "<cmd>lua require('harpoon'):list():select(1)<cr>", opts)
  keymap("n", "m", "<cmd>lua require('harpoon'):list():select(2)<cr>", opts)
  keymap("n", ",", "<cmd>lua require('harpoon'):list():select(3)<cr>", opts)
  keymap("n", ".", "<cmd>lua require('harpoon'):list():select(4)<cr>", opts)
